...
enet_neural_network = cv2.dnn.readNet('/your/path/to/enet/enet-model.net') # TODO: adjust the path here

class_names = (
    open('/your/path/to/enet/enet-classes.txt').read().strip().split("\n")) # TODO: adjust the path here
